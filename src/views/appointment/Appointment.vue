  ...
  <div id="simple-calendar-app">
    ...
    <vs-prompt
        ...
        <div class="my-4">
            ...
            <datepicker :language="$vs.rtl ? langHe : langEn" name="start-date" v-model="startDate"></datepicker>
        </div>
    </vs-prompt>
...
export default {
  ...
  methods: {
    addEvent () {
      ...
      const obj = { title: this.title, startDate: this.startDate, endDate: this.endDate, label: this.labelLocal }
